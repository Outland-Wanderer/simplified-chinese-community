...
translate schinese Bandit_Den_fcd8547a:
    ...
    tut "如果你用的是电脑，请通过键入键盘上的 W、A、S、D 键，或者点击屏幕上的箭头，分别操控[e]行走的方向。"
...
translate schinese Bandit_Den_Shelf_6442032d:
    ...
    "安王室咨义师谢尔爱莲……总之是个人所考，近日羊氏之邑凯奇奥伦旁有爆发，或因不明魔力所致。"
...
translate schinese Bandit_Den_Shelf_c74802aa:
    ...
    # The recent explosion near Kechioeren (Goat Tribe), seems to be caused by an unknown magical force.
    pass
...
translate schinese Bandit_Den_Shelf_06c1cc94:
    ...
    # These two recent event might n-
    "此二事或有关联，未可断言——"
