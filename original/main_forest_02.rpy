...
translate schinese Uffe_Celebration_Orgy_0ea1fe0a:
...
translate schinese Uffe_Celebration_Orgy_6c153b8a:

    # "Not to mention the echoes in the werewolf den, which makes it ten times worse than you'd think."
    ""

translate schinese Uffe_Celebration_Orgy_42bf90be:
...
translate schinese Uffe_Territory_Quest_d029f3da:

    # "That was an abrupt threat, you can't figure out of what to say."
    ""

translate schinese Uffe_Territory_Quest_1f096601:

    # u "Any questions, you better ask right now."
    u ""

translate schinese Uffe_Territory_Quest_8b5b4122:

    # "You shrug reluctantly."
    ""

translate schinese Uffe_Territory_Quest_37437373:

    # u "Now, we need to expand our territories here, starting from the hollow."
    u ""

translate schinese Uffe_Territory_Quest_7b1c1392:

    # u "..."
    u ""

translate schinese Uffe_Territory_Quest_12b9d1fe:

    # "The leader waits for you to speak, but you decide to remain silent in protest of his unfulfilled wish."
    ""

translate schinese Uffe_Territory_Quest_a2fed154:

    # u "The hollow is located between our territories, and the slimes', west of the split trails."
    u ""

translate schinese Uffe_Territory_Quest_e09b30f6:

    # e "W-what do you need exactly?"
    e ""

translate schinese Uffe_Territory_Quest_31536831:

    # u "It buries a dark treasure, moonstone amulet. I need you to clear the area, and retrieve what's there for me."
    u ""

translate schinese Uffe_Territory_Quest_cce39311:

    # u "Now go, trespasser."
    u ""

translate schinese Uffe_Territory_Quest_c111e248:

    # e "W-wait, why me? You have other werewolves who are definitely more competent, if not stronger."
    e ""

translate schinese Uffe_Territory_Quest_59684541:

    # "Uffe only gives a a side glance, not even a full one, he chuckles, and returns to his business."
    ""

translate schinese Uffe_Territory_Quest_a58c915c:

    # e "...Alright"
    e ""

translate schinese Uffe_Territory_Quest_a048460b:

    # "You can feel the other werewolves staring at your dumbfounded face as you remain standing."
    ""

translate schinese Uffe_Territory_Quest_a4786d2d:

    # "Uffe doesn't bat you another eye before you eventually take your leave."
    ""

translate schinese Uffe_Territory_Quest_Return_After_Amulet_afc0fca9:

    # "You notice dozen pairs of eyes hiding in the darkness,. The usual werewolves were staring at you from the corners."
    ""

translate schinese Uffe_Territory_Quest_Return_After_Amulet_580e8974:

    # e "Uffe, here's the amulet."
    e ""

translate schinese Uffe_Territory_Quest_Return_After_Amulet_8d4747d6:

    # "Something strange is emanating from within the moonstone as you present it in front of Uffe, who takes it eagerly."
    ""

translate schinese Uffe_Territory_Quest_Return_After_Amulet_f1350236:

    # u "Well done yet again, trespasser."
    u ""

translate schinese Uffe_Territory_Quest_Return_After_Amulet_af79e0df:

    # "He doesn't even bat you another eye, just entirely focused on the amulet."
    ""

translate schinese Uffe_Territory_Quest_Return_After_Amulet_dd786691:

    # e "Did you send me because your wolves are too stupid to solve riddles?"
    e ""

translate schinese Uffe_Territory_Quest_Return_After_Amulet_56609d0f:

    # "Uffe finally glances at you, albeit it's of a hostile nature."
    ""

translate schinese Uffe_Territory_Quest_Return_After_Amulet_648976f0:

    # u "Stupid? We could have torn you apart right now, including your measly little brain."
    u ""

translate schinese Uffe_Territory_Quest_Return_After_Amulet_51b70f01:

    # u "Cleverness doesn't help you survive in this world, trespasser."
    u ""

translate schinese Uffe_Territory_Quest_Return_After_Amulet_6cf36f0c:

    # e "Then how come you asked me to solve the riddles?"
    e ""

translate schinese Uffe_Territory_Quest_Return_After_Amulet_8bb2680d:

    # u "I can ask you, or, I can put you between my fangs, do you prefer the latter?"
    u ""

translate schinese Uffe_Territory_Quest_Return_After_Amulet_f790365e:

    # "You shrug, which only gets Uffe to chuckle lightly."
    ""

translate schinese Uffe_Territory_Quest_Return_After_Amulet_7c699b65:

    # u "That's what I thought."
    u ""

translate schinese Uffe_Territory_Quest_Return_After_Amulet_d027dc86:

    # "The werewolf alpha puts away the amulet."
    ""

translate schinese Uffe_Territory_Quest_Return_After_Amulet_05a9cffd:

    # u "You can go now."
    u ""

translate schinese Uffe_Territory_Quest_Return_After_Amulet_9cf2c6d0:

    # e "Are you still not letting me know about the stone, after everything I did?"
    e ""

translate schinese Uffe_Territory_Quest_Return_After_Amulet_41a78b03:

    # u "I've told you what I know, it's only you who insists I didn't."
    u ""

translate schinese Uffe_Territory_Quest_Return_After_Amulet_f9a01fe1:

    # "You remain silent, perhaps he's right. You are just helping someone who doesn't appreciate your worth."
    ""

translate schinese Uffe_Territory_Quest_Return_After_Amulet_71691b5a:

    # e "Alright then."
    e ""

translate schinese Uffe_Territory_Quest_Return_After_Amulet_48dc8cd8:

    # "Uffe stares at you once again, this time of a cautious nature."
    ""

translate schinese Uffe_Territory_Quest_Start_Runaways_249a39f0:

    # "You arrive in front of the werewolf once more, and the first thing you notice is the extra pairs of eyes staring upon you."
    ""

translate schinese Uffe_Territory_Quest_Start_Runaways_c4e47864:

    # u "Welcome back, trespasser."
    u ""

translate schinese Uffe_Territory_Quest_Start_Runaways_ef1fddc8:

    # e "Uffe."
    e ""

translate schinese Uffe_Territory_Quest_Start_Runaways_47acd1ff:

    # "You address the alpha with a slightly deeper voice, of which raised his brows briefly."
    ""

translate schinese Uffe_Territory_Quest_Start_Runaways_7cfb9203:

    # u "Now that you have proven yourself to be useful. There's another problem I need someone like you to deal with."
    u ""

translate schinese Uffe_Territory_Quest_Start_Runaways_042ba5d6:

    # u "We've found a group of traitors, runaways, who weren't fit to live in this world."
    u ""

translate schinese Uffe_Territory_Quest_Start_Runaways_ad76d63c:

    # u "They killed a few of ours, and now they plan to escape from the forest, but that's not going to happen."
    u ""

translate schinese Uffe_Territory_Quest_Start_Runaways_88e456e2:

    # "Uffe glances at you, twiddling his claws against your neck, you instinctively flinch."
    ""

translate schinese Uffe_Territory_Quest_Start_Runaways_73f72fff:

    # e "What does that mean, exactly?"
    e ""

translate schinese Uffe_Territory_Quest_Start_Runaways_89e01257:

    # u "It means, we're not letting them leave our territory."
    u ""

translate schinese Uffe_Territory_Quest_Start_Runaways_142c8f80:

    # "His message was rather obvious, you understand that he wants them gone, just like how he wanted his own brother gone."
    ""

translate schinese Uffe_Territory_Quest_Start_Runaways_27ff24ec:

    # u "Those little weak links will flee like cowards if they see anything that resembles a wolf."
    u ""

translate schinese Uffe_Territory_Quest_Start_Runaways_6e13040e:

    # u "So, I need you to bring them back to me, we'll take over after that."
    u ""

translate schinese Uffe_Territory_Quest_Start_Runaways_3e7f964b:

    # e "I- What are you going to do with them?"
    e ""

translate schinese Uffe_Territory_Quest_Start_Runaways_e0486a83:

    # u "You know exactly what I'm going to do."
    u ""

translate schinese Uffe_Territory_Quest_Start_Runaways_09c937b0:

    # e "Why? They're already out of the picture, can't you leave them be?"
    e ""

translate schinese Uffe_Territory_Quest_Start_Runaways_54252a80:

    # "Uffe raises his eyebrow, his grin vanishes as soon as you finish your sentence."
    ""

translate schinese Uffe_Territory_Quest_Start_Runaways_77c73601:

    # u "Here I thought you were fit for the rules of nature."
    u ""

translate schinese Uffe_Territory_Quest_Start_Runaways_7e5be565:

    # e "What?"
    e ""

translate schinese Uffe_Territory_Quest_Start_Runaways_adea7e66:

    # "He takes a great sigh, and the pack of werewolves behind you immediately tense up."
    ""

translate schinese Uffe_Territory_Quest_Start_Runaways_b09c993a:

    # u "Trespasser, why do you think only our pack survives in this forest?"
    u ""

translate schinese Uffe_Territory_Quest_Start_Runaways_d4cd2d06:

    # e "Because you killed everything else?"
    e ""

translate schinese Uffe_Territory_Quest_Start_Runaways_0fb298ca:

    # u "Partly, but there's something more important than killing."
    u ""

translate schinese Uffe_Territory_Quest_Start_Runaways_74445d28:

    # u "We survive, we adapt, and we do not hesitate to put out the wildfires before it spreads."
    u ""

translate schinese Uffe_Territory_Quest_Start_Runaways_c8b472e2:

    # "You're not sure if you agree with the wolf even so slightly."
    ""

translate schinese Uffe_Territory_Quest_Start_Runaways_1481697f:

    # u "So, are you a wildfire?" nointeract
    u "" nointeract

translate schinese Uffe_Territory_Quest_Start_Runaways_e4410d82:

    # e "Alright, I'll do it."
    e ""

translate schinese Uffe_Territory_Quest_Start_Runaways_768e5c86:

    # u "Good, maybe after this you'll become one of us."
    u ""

translate schinese Uffe_Territory_Quest_Start_Runaways_1990fcc9:

    # e "One of you?"
    e ""

translate schinese Uffe_Territory_Quest_Start_Runaways_6c5814ca:

    # u "Yes, but first, bring the runaways back to me, then we'll talk about celebration."
    u ""

translate schinese Uffe_Territory_Quest_Start_Runaways_ac63d50e:

    # u "Good, then."
    u ""

translate schinese Uffe_Territory_Quest_Start_Runaways_5ad089c4:

    # "The leader hands you a small wolf-shaped whistle."
    ""

translate schinese Uffe_Territory_Quest_Start_Runaways_84c58b85:
...
translate schinese Uffe_Territory_Quest_Runaways_c13d718f:

    # e "Herbalist wolf?"
    e ""

translate schinese Uffe_Territory_Quest_Runaways_4808df18:

    # my "He walks around the forest, do you not know him?"
    my ""

translate schinese Uffe_Territory_Quest_Runaways_258b58d1:

    # "The werewolf pauses over the door, seems like he's staring at the other direction."
    ""

translate schinese Uffe_Territory_Quest_Runaways_162da881:

    # my "Can you help us? I must stay in case of any other werewolves coming in."
    my ""

translate schinese Uffe_Territory_Quest_Runaways_3681f1cd:

    # "You walk around, but find nothing."
    ""

translate schinese Uffe_Territory_Quest_Runaways_0bb8a53d:

    # e "I- I don't think I have anything that can help him."
    e ""

translate schinese Uffe_Territory_Quest_Runaways_57a92751:

    # my "That's alright, I'll think of another way."
    my ""

translate schinese Uffe_Territory_Quest_Runaways_324e6a2b:

    # "Without another thought, he turns away."
    ""

translate schinese Uffe_Territory_Quest_Runaways_61f642e1:

    # "You hear the footsteps of the werewolf leaving to tend to his brother, before you retreat from the door as well."
    ""

translate schinese Uffe_Territory_Quest_Runaways_End_b4fa7e8d:

    # "You approach the alpha once more."
    ""

translate schinese Uffe_Territory_Quest_Runaways_End_fe5eda14:

    # u "Congratulations, my little trespasser. The threat has been eliminated, as it should."
    u ""

translate schinese Uffe_Territory_Quest_Runaways_End_834c8ef8:

    # u "Keep the whistle, as a reward."
    u ""

translate schinese Uffe_Territory_Quest_Runaways_End_66df7fbb:

    # e "What are you going to do with them?"
    e ""

translate schinese Uffe_Territory_Quest_Runaways_End_b45f40e0:

    # u "I'm sorry?"
    u ""

translate schinese Uffe_Territory_Quest_Runaways_End_4d3c304e:

    # e "What are you going to d-"
    e ""

translate schinese Uffe_Territory_Quest_Runaways_End_53369edd:

    # u "Look, you might not remember the rules in my forest for merely a second here. Let me reiterate."
    u ""

translate schinese Uffe_Territory_Quest_Runaways_End_aebd86cf:

    # "The alpha cuts you off, he is visibly annoyed."
    ""

translate schinese Uffe_Territory_Quest_Runaways_End_c8eaab5d:

    # u "I'll do with them however I want, and it's not something I will tell a trespasser."
    u ""

translate schinese Uffe_Territory_Quest_Runaways_End_23e5ffc3:

    # u "However, you seem visibly upset for strangers you know nothing about."
    u ""

translate schinese Uffe_Territory_Quest_Runaways_End_3c65e6f4:

    # u "Let me comfort you, the brothers are sound and safe, for all it's worth."
    u ""

translate schinese Uffe_Territory_Quest_Runaways_End_c2b003d7:

    # e "You still haven't answered my questions."
    e ""

translate schinese Uffe_Territory_Quest_Runaways_End_76546a42:

    # "Uffe chides."
    ""

translate schinese Uffe_Territory_Quest_Runaways_End_b87788c9:

    # u "Now you've crossed the line. I don't really owe you an explanation, trespasser."
    u ""

translate schinese Uffe_Territory_Quest_Runaways_End_9fb556fb:

    # u "But consider that you've contributed to the pack. I will forgive you."
    u ""

translate schinese Uffe_Territory_Quest_Runaways_End_3dd0ceb1:

    # u "And mayhaps, come another time. We'll hold a celebration for the removal of all threats."
    u ""

translate schinese Uffe_Territory_Quest_Runaways_End_7df617a4:

    # "You remain silent, by now you know everything you say will be disregarded."
    ""

translate schinese Uffe_Territory_Quest_Runaways_End_fec5f55d:

    # "And despite your action, you were right, the guilt of blowing the whistle is building up on you."
    ""

translate schinese Uffe_Territory_Quest_Runaways_End_53a60d55:

    # "Alongside what you've done to Vurro..."
    ""

translate schinese Uffe_Territory_Quest_Runaways_End_c896e7be:

    # "It's not going to go away."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_6b70fcfd:

    # e "Uhmm..."
    e ""

translate schinese Uffe_Territory_Quest_Find_Cream_c11334f3:

    # "You scramble through your bag, and finds a canister of green ointment."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_f6f37971:

    # e "Would this help?"
    e ""

translate schinese Uffe_Territory_Quest_Find_Cream_48eea0fa:

    # "Through the hole, you raise your hand high enough for the wolf."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_5221f0d0:

    # my "What's that?"
    my ""

translate schinese Uffe_Territory_Quest_Find_Cream_263a01ef:

    # e "Ointment, it should stop the bleeding speedily. Ol- A lizard from outside the forest gave the recipe to me."
    e ""

translate schinese Uffe_Territory_Quest_Find_Cream_55d9376e:

    # my "That will help?"
    my ""

translate schinese Uffe_Territory_Quest_Find_Cream_88725662:

    # e "I'm pretty sure."
    e ""

translate schinese Uffe_Territory_Quest_Find_Cream_a6ca64fd:

    # "Clumsily, you throw it over the hole in the door, the concerned wolf catches the canister before it breaks on the floor."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_631a6d3a:

    # "He quickly rushes towards the back of the hut, muttering something very quickly."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_1fc15b3d:

    # "You wait at the door, and it's been almost an hour passed before the wolf approaches you again."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_52fb519f:

    # my "Thank you so much, I- I think my brother's getting better now, his bleeding has stopped and I wiped his wounds clean."
    my ""

translate schinese Uffe_Territory_Quest_Find_Cream_65508ba3:

    # e "T-that's great, I'm happy to have helped you."
    e ""

translate schinese Uffe_Territory_Quest_Find_Cream_212f93f4:

    # my "Do you want to come in?"
    my ""

translate schinese Uffe_Territory_Quest_Find_Cream_118adec5:

    # e "Yes."
    e ""

translate schinese Uffe_Territory_Quest_Find_Cream_0d74ee2f:

    # "The werewolf flips open the wooden plank, and greets you politely."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_5688ed42:

    # "It's only after entering the hiding place you notice how small it is."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_13f25f51:

    # "And the werewolf is taller than you imagined, almost like a giant as compared to the compact household he's living in."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_a6bb13e5:
...
translate schinese Uffe_Territory_Quest_Find_Cream_dc21eb6d:

    # my "S-sorry, it's small but we are not staying for long here."
    my ""

translate schinese Uffe_Territory_Quest_Find_Cream_b19a9e16:

    # "You sit on the leafy mat alongside the werewolf."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_37c19554:

    # tt "My name's Tetto, it was really nice to meet you."
    tt ""

translate schinese Uffe_Territory_Quest_Find_Cream_83e2f008:

    # e "My name's [e]. Thank you for having me here, Tetto."
    e ""

translate schinese Uffe_Territory_Quest_Find_Cream_7e0dd842:

    # e "Where are you going?"
    e ""

translate schinese Uffe_Territory_Quest_Find_Cream_268d878b:

    # tt "Somewhere far away from the forest, once my brother can walk again."
    tt ""

translate schinese Uffe_Territory_Quest_Find_Cream_3884e7c2:

    # e "I apologise if I stepped out of line, but what happened to your brother?"
    e ""

translate schinese Uffe_Territory_Quest_Find_Cream_f6ca09a5:

    # "The werewolf scratches his head."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_242f534e:
...
translate schinese Uffe_Territory_Quest_Find_Cream_f7aa6954:
...
translate schinese Uffe_Territory_Quest_Find_Cream_6bbccce5:

    # "You thoughts was put to a sudden halt as you hear the series of whines again."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_1f58b189:

    # tt "O-oh?"
    tt ""

translate schinese Uffe_Territory_Quest_Find_Cream_b4497e10:

    # tt "It's my brother. I'll check on him for just a few moments."
    tt ""

translate schinese Uffe_Territory_Quest_Find_Cream_b5798c21:

    # "The werewolf climbs on the tunnel, and soon you are left alone..."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_b4a35f9a:

    # "You take out the whistle, there's no pulling out now."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_a4a30430:

    # "There's no way you can blow it here."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_2881133f:

    # "You leave the place with a look of sorrow, before barely sealing the plank at the entrance."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_6aeeec2d:

    # "Indecisively, you close your eyes, and let your mouth blow a soft wind through the whistle."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_dc7068f1:

    # "A loud sound emulating wolf howling can be heard through the whole forest."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_6484a0bd:

    # "You run away from the shelter, knowing what will happen to them."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_f68064e8:

    # "And you do not even dare to look behind."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_4ecb9225:

    # "You do not have the courage to see what you're doing to them."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_59bb6834:

    # "Soon, a group of werewolves emerges from the corner, running in opposite direction of yours."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_af23c6b6:

    # "One of the werewolves stops you."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_bec3aaa9:

    # ww "You got their doors unlocked?"
    ww ""

translate schinese Uffe_Territory_Quest_Find_Cream_6186867a:

    # "You nod."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_d98e7959:

    # ww "Good job there, Uffe will be very pleased."
    ww ""

translate schinese Uffe_Territory_Quest_Find_Cream_39acc06a:

    # "You wish it was a sarcasm, but he genuinely believed you did a good thing."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_9a3b67cb:

    # e "Are they going to die?"
    e ""

translate schinese Uffe_Territory_Quest_Find_Cream_05886071:

    # ww "What? Hah- If we wanted to kill them, they'd die a long time ago."
    ww ""

translate schinese Uffe_Territory_Quest_Find_Cream_0999ae93:

    # ww "We just didn't want them to escape, or die that easily."
    ww ""

translate schinese Uffe_Territory_Quest_Find_Cream_d916959f:

    # "The werewolf points at his head, and grins at you menacingly."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_2e2f23b2:

    # "You are not sure what he means, how would Uffe not kill a threat to their own pack."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_af683f97:

    # "What's even the purpose of catching them alive?"
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_927eea20:

    # ww "Leave the hard works to us, little prey."
    ww ""

translate schinese Uffe_Territory_Quest_Find_Cream_efbcbcbc:

    # ww "Oh, and you should go tell Uffe about the good news, I'm sure he has something better ready for you."
    ww ""

translate schinese Uffe_Territory_Quest_Find_Cream_4580b4a2:

    # "The werewolf chuckles, before heading the direction to the shelter."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_bea31d56:

    # "And you are left standing there, speechless."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_a9c848fb:

    # "You can only hope they have fled, somehow. Even if it's unrealistic."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_2e84dca1:

    # e "Hey, Tetto, you need to leave... now."
    e ""

translate schinese Uffe_Territory_Quest_Find_Cream_f026b0c5:

    # tt "W-what?"
    tt ""

translate schinese Uffe_Territory_Quest_Find_Cream_3d5270c8:

    # e "Carry your brother and leave the forest, the werewolves are chasing after you."
    e ""

translate schinese Uffe_Territory_Quest_Find_Cream_4d211de9:

    # e "They are coming here right now! So please... run."
    e ""

translate schinese Uffe_Territory_Quest_Find_Cream_5654ba5c:

    # "You shout at the other end of the tunnel, the werewolf seems to be pondering for a moment."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_e3d5e1a9:

    # "He ponders for a moment, before looking outside through a peephole."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_f992a567:

    # "It only get him much more anxious, as he immediately rushes towards his brother."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_004a3d2a:

    # tt "Fuck- you're right. Okay, I'm so lucky he built a secret exit right here, I'll carry my brother."
    tt ""

translate schinese Uffe_Territory_Quest_Find_Cream_ca020225:

    # e "I'll do whatever I can, please, run as far as you can."
    e ""

translate schinese Uffe_Territory_Quest_Find_Cream_3aef8799:

    # tt "Alright, alright. I can do this."
    tt ""

translate schinese Uffe_Territory_Quest_Find_Cream_882662a2:

    # "Tetto groans as he carries his brother on his back, you can still hear a few whimpers from the brother."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_ddca1947:

    # tt "[e], may we meet outside."
    tt ""

translate schinese Uffe_Territory_Quest_Find_Cream_affbb762:

    # "A faint gruntle echoes from the other end of the tunnel. And you can only hope they've escaped."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_863894c9:

    # "You wait for a few seconds alone in the hiding place."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_d8bd2fc4:

    # "They must not catch them until you blow your whistle, as you believe."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_93224bbd:

    # e "Hey! I should accompany you two, it's too dangerous."
    e ""

translate schinese Uffe_Territory_Quest_Find_Cream_9ad41c1f:

    # "You shout loudly, but receive no response except for your echoes."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_e92d1514:

    # "Despite the silence, you climb into the tunnel, hoping to catch up to the brothers."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_2c351a03:

    # "With a certain ease and dust on your body, you reached where his brother was resting."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_87591478:

    # "There are an incredible amount of blood left behind, almost enough to stain a whole carpet."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_710b8610:

    # "But, without another thought, you hurry to flip away layers and layers of leaves hiding the other exit."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_1c5c4593:

    # "Running into several huge bushes, you see the back of a werewolf moving slowly above the grasses."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_9c2b1e20:

    # "When you walk up to the werewolf's side, you realise he's sleeping soundly, being carried by his brother underneath."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_95bea4e4:

    # e "Tetto, I figured maybe you can use an extra pair of eyes."
    e ""

translate schinese Uffe_Territory_Quest_Find_Cream_c16e797b:

    # tt "Hnnngh... Good."
    tt ""

translate schinese Uffe_Territory_Quest_Find_Cream_037aaa36:

    # "Tetto gruntles as his brother almost slips off."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_86cd8374:
...
translate schinese Uffe_Territory_Quest_Find_Cream_9d2c83b8:

    # "At last, he finally quiets down. But that doesn't stop the werewolf's pursuit."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_aa1b37b3:

    # "Instead, you notice another similar figure approaching."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_b634616f:

    # ww "Got any tails? Uffe's gonna be pissed if we let them escape."
    ww ""

translate schinese Uffe_Territory_Quest_Find_Cream_1c1b51cc:

    # ww2 "No, but I just received order from the alpha. We better take them back as soon as we can."
    ww2 ""

translate schinese Uffe_Territory_Quest_Find_Cream_c10418db:

    # ww "Including the small one?"
    ww ""

translate schinese Uffe_Territory_Quest_Find_Cream_fb3a4346:

    # ww2 "No."
    ww2 ""

translate schinese Uffe_Territory_Quest_Find_Cream_8b06c217:

    # "The werewolves talks amongst themselves nonchalantly, sharpening their claws as they search."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_09f6d4e2:

    # "You hold your breath behind the giant tree, and signal Tetto to escape as soon as the werewolves leave."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_371deeeb:

    # ww "Someone's been here."
    ww ""

translate schinese Uffe_Territory_Quest_Find_Cream_00771fda:

    # "The two look across the path you just took, and they immediately follows the scent down there."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_a64bd019:

    # "You continue to hold your breath, just a few more seconds before they leave."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_7f6ccb4c:

    # "One... More..."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_1a502c10:

    # "Alas, you flinch and step on the dry branches, eliciting a loud cracking sound."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_d2e509be:

    # "Tetto puts down his sleeping brother silently, he knows the werewolves turned around."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_914f704f:

    # "And he was right, they are approaching the source of the sound with no other way to escape."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_6bbead98:

    # tt "{size=15}Prepare to fight, [e]. We need to make this quick.{/size}"
    tt ""

translate schinese Uffe_Territory_Quest_Find_Cream_5d0fecf3:

    # "A black snout pokes from behind the tree, revealing the inquisitive dark werewolf."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_730d00a9:

    # ww "Ha, caught you."
    ww ""

translate schinese Uffe_Territory_Quest_Find_Cream_a91fa821:

    # ww2 "And his little accomplice."
    ww2 ""

translate schinese Uffe_Territory_Quest_Find_Cream_5f8bb962:

    # "You have no way to escape now, being caught between the two werewolves."
    ""

translate schinese Uffe_Territory_Quest_Find_Cream_fc4c6e5a:

    # tt "W-well, let's get this over with."
    tt ""

translate schinese Uffe_Territory_Quest_Inquire_947f08fc:

    # e "Uffe, what do I need to do again?"
    e ""

translate schinese Uffe_Territory_Quest_Inquire_230a3643:

    # "The werewolf leader gives you a side glance, and it's demeaning as usual."
    ""

translate schinese Uffe_Territory_Quest_Inquire_f796a9de:

    # u "Get to the Hollow on your map, clear shrubs. And retrieve the amulet."
    u ""

translate schinese Uffe_Territory_Quest_Inquire_5ab1419f:

    # e "Uhm, where's the amulet?"
    e ""

translate schinese Uffe_Territory_Quest_Inquire_0a1a5eca:

    # u "I've assigned a fellow capable hunter where it lies, help him, and you'll get my amulet."
    u ""

translate schinese Uffe_Territory_Quest_Inquire_fdac3ef9:
