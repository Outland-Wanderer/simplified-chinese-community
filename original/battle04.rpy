...
translate schinese ratbandit_battle_74af631b:
...
translate schinese ratbandit_battle_fb9c8185:
...
translate schinese ratbandit_battle_loop_b770443e:
...
translate schinese ratbandit_battle_loop_9372f5e5:
...
translate schinese ratbandit_battle_loop_d49fcdeb:
...
translate schinese ratbandit_battle_loop_63ca8138:

    # "You aim and shoot your [pc.weapon.name!t] at the rat, the arrow hit right into his shoulder."
    ""

translate schinese ratbandit_battle_loop_64450b04:
...
translate schinese ratbandit_battle_loop_04ec1408:

    # "You throw your fist at the rat, hitting him right across his face, the sheer impact knocks him on the ground."
    ""

translate schinese ratbandit_battle_loop_5fc11c2d:

    # "You punch into the rat's stomach, grabbing him and slam him on the ground hard."
    ""

translate schinese ratbandit_battle_loop_24bcc736:

    # "His health decreases by [oa[4]] HP."
    ""

translate schinese ratbandit_battle_loop_17a649f0:

    # "You've critically hit the bandit, dealing [oa[4]] HP!"
    ""

translate schinese ratbandit_battle_loop_f58127ce:

    # rbd "Argh! I haven't been hit for a long time!"
    rbd ""

translate schinese ratbandit_battle_loop_8b58beea:

    # rbd "What's the thing that made you aim that well. That's impossible!"
    rbd ""

translate schinese ratbandit_battle_loop_409a4a3d:

    # rbd "e-eeeek...! You're not going to hit me twice in a row!"
    rbd ""

translate schinese ratbandit_battle_loop_850f80c2:

    # rbd "fffff- I have to get out of this soon."
    rbd ""

translate schinese ratbandit_battle_loop_fdf9de27:

    # "You turn around and rub your hand all over your own burly cheeks, feeling and brushing against your ass while you shake your hip."
    ""

translate schinese ratbandit_battle_loop_ea17c91d:
...
translate schinese ratbandit_battle_loop_73a3b51a:
...
translate schinese ratbandit_battle_loop_1fd87d43:

    # "You continue your act for about a minute, but the bandit doesn't even flinch."
    ""

translate schinese ratbandit_battle_loop_26bf6beb:

    # rbd "Well..."
    rbd ""

translate schinese ratbandit_battle_loop_418a221b:
...
translate schinese ratbandit_battle_loop_a8f3880c:

    # rbd "...I-if you do this one more time I'm going to grab that huge ass and never let you go..."
    rbd ""

translate schinese ratbandit_battle_loop_ae30f3f4:
...
translate schinese ratbandit_battle_loop_af62cd2a:

    # rbd "You are w-wasting your time. I'm n-not... I'm not... I- uhh... nooo..."
    rbd ""

translate schinese ratbandit_battle_loop_34befdba:
...
translate schinese ratbandit_battle_loop_fe4a1e82:

    # rbd "N-noooo... I'm not- h-horny!"
    rbd ""

translate schinese ratbandit_battle_loop_e9df915d:
...
translate schinese ratbandit_battle_loop_d32212bc:

    # rbd "Heh, this is what precision looks like."
    rbd ""

translate schinese ratbandit_battle_loop_365ff672:
...
translate schinese ratbandit_battle_loop_0b1f2116:

    # "You stare at him, giving him weird side eyes. You have evaded his attempt at seduction."
    ""

translate schinese ratbandit_battle_loop_9b3dd47a:
...
translate schinese ratbandit_battle_loop_86aaba75:

    # rbd "Take a look at this, well you get to touch it if you promise not to chase after me ever again."
    rbd ""

translate schinese ratbandit_battle_loop_21bad776:
...
translate schinese sharkbandit_battle_loop_132b45ce:

    # "You slash your [pc.weapon.name!t] at the arm of the shark, but it only scratches his skin."
    ""

translate schinese sharkbandit_battle_loop_9368897c:

    # "You slam your [pc.weapon.name!t] at the shark's head, but it only scratches his skin."
    ""

translate schinese sharkbandit_battle_loop_6088e10f:

    # "You aim and shoot your [pc.weapon.name!t] at the shark, but it only scratches his skin."
    ""

translate schinese sharkbandit_battle_loop_fa9cc593:

    # "You throw your fist at the shark, but it only scratches his skin."
    ""

translate schinese sharkbandit_battle_loop_6bedc127:

    # sbd "That's all you got?"
    sbd ""

translate schinese sharkbandit_battle_loop_b3f9639a:

    # sbd "Huh."
    sbd ""

translate schinese sharkbandit_battle_loop_57889d5c:
...
translate schinese sharkbandit_battle_loop_9574a4a0:
...
translate schinese sharkbandit_battle_loop_e879391d:
...
translate schinese sharkbandit_battle_loop_fb9bd1b0:
...
translate schinese sharkbandit_battle_loop_a38345ad:

    # "You aim and shoot your [pc.weapon.name!t] at the shark, the arrow hit right into his shoulder."
    ""

translate schinese sharkbandit_battle_loop_7cf88a11:
...
translate schinese sharkbandit_battle_loop_d42a88ab:

    # "You throw your fist at the shark, hitting him right across his face, the sheer impact knocks him on the ground."
    ""

translate schinese sharkbandit_battle_loop_ea49aba5:

    # "You punch into the shark's stomach, grabbing him and slam him on the ground hard."
    ""

translate schinese sharkbandit_battle_loop_24bcc736:

    # "His health decreases by [oa[4]] HP."
    ""

translate schinese sharkbandit_battle_loop_17a649f0:

    # "You've critically hit the bandit, dealing [oa[4]] HP!"
    ""

translate schinese sharkbandit_battle_loop_a3975f77:

    # sbd "Argh! I haven't been hit for a long time!"
    sbd ""

translate schinese sharkbandit_battle_loop_4b43a7a6:

    # sbd "It's just a scratch..."
    sbd ""

translate schinese sharkbandit_battle_loop_5fb6f023:

    # sbd "N-not, giving... up."
    sbd ""

translate schinese sharkbandit_battle_loop_e77c28bd:

    # sbd "I'll beat you RIGHT HERE! Come closer!"
    sbd ""

translate schinese sharkbandit_battle_loop_fdf9de27:

    # "You turn around and rub your hand all over your own burly cheeks, feeling and brushing against your ass while you shake your hip."
    ""

translate schinese sharkbandit_battle_loop_f41f674d:
...
translate schinese sharkbandit_battle_loop_89520abd:
...
translate schinese sharkbandit_battle_loop_1fd87d43:

    # "You continue your act for about a minute, but the bandit doesn't even flinch."
    ""

translate schinese sharkbandit_battle_loop_d1f660f9:

    # sbd "Well..."
    sbd ""

translate schinese sharkbandit_battle_loop_8e008ede:
...
translate schinese sharkbandit_battle_loop_dbb089b2:

    # sbd "...I-if you do this one more time I'm going to grab that huge ass and never let you go..."
    sbd ""

translate schinese sharkbandit_battle_loop_d0975aae:
...
translate schinese sharkbandit_battle_loop_b6528234:

    # sbd "You are w-wasting your time. I'm n-not... I'm not... I- uhh... nooo..."
    sbd ""

translate schinese sharkbandit_battle_loop_4896910c:
...
translate schinese sharkbandit_battle_loop_9659ff35:

    # sbd "...It's nothing."
    sbd ""

translate schinese sharkbandit_battle_loop_e9df915d:

    # "You can tell the bandit is already playing with himself when his hand goes under his loincloth, staring at your ass intently. His lust is increased by [player_flirt]."
    ""

translate schinese sharkbandit_battle_loop_ef0db693:

    # sbd "Hnnnngh... ."
    sbd ""

translate schinese sharkbandit_battle_loop_42c3d693:

    # "The shark is blocking your escape..."
    ""

translate schinese sharkbandit_battle_loop_08d35d75:

    # "You are not ready to surrender yet."
    ""

translate schinese sharkbandit_battle_loop_791d4b96:
...
translate schinese sharkbandit_battle_loop_4b5a513f:
...
translate schinese sharkbandit_battle_loop_97c0625a:

    # sbd "I'll strike you down, like anyone else in my way."
    sbd ""

translate schinese sharkbandit_battle_loop_90f6895e:

    # "The shark bandit swings his axe towards you, you managed to deflect his bow and dodge the attack."
    ""

translate schinese sharkbandit_battle_loop_5baea727:

    # sbd "Lucky dodge."
    sbd ""

translate schinese sharkbandit_battle_loop_c5c89a14:
...
translate schinese sharkbandit_battle_loop_984e827c:

    # sbd "Come here, traveller. Need a drink?"
    sbd ""

translate schinese sharkbandit_battle_loop_71755195:

    # "You gulp at his attempt at seduction. Admittedly you are extremely aroused, thinking about how his cock would taste like. Your lust increased by [enemy_flirt]."
    ""

translate schinese sharkbandit_battle_loop_0b1f2116:

    # "You stare at him, giving him weird side eyes. You have evaded his attempt at seduction."
    ""

translate schinese sharkbandit_battle_loop_9b3dd47a:

    # "The bandit stretches his body, flaunting his muscular physiques, you can tell his soft chest is almost bulging in front of you."
    ""

translate schinese sharkbandit_battle_loop_4ea0e3c8:

    # sbd "I can see your lustful eyes, you must be wanting this, don't you."
    sbd ""

translate schinese sharkbandit_battle_loop_21bad776:

    # "You are stunned by his gorgeous muscles, you mind wanders through scenarios of him being inside your body. Your lust increased by [enemy_flirt]."
    ""

translate schinese sharkbandit_battle_loop_05b754b3:

    # "His attack at your lust seems to have failed as you stand there and wait for him to finish his taunt."
    ""

translate schinese sharkbandit_battle_loop_74a9e76b:

    # sbd "Ughhh-!!"
    sbd ""

translate schinese sharkbandit_battle_loop_4fe9c6fa:
...
translate schinese sharkbandit_battle_lose_14ee31c3:

    # sbd "So rare would we see a traveler just deliver himself right at my front door."
    sbd ""

translate schinese sharkbandit_battle_lose_452e5ccd:

    # sbd "Often we have to actually round these guys up, beat them up and take whatever we want."
    sbd ""

translate schinese sharkbandit_battle_lose_2f5d0fa9:

    # sbd "You were a good fighter."
    sbd ""

translate schinese sharkbandit_battle_lose_c610e3f0:

    # sbd "But, it still ends the same way it ends, with me on top."
    sbd ""

translate schinese sharkbandit_battle_lose_5597b182:

    # sbd "Now..."
    sbd ""

translate schinese sharkbandit_battle_lose_eb34bd6c:

    # sbd "Why are you here, traveller."
    sbd ""

translate schinese sharkbandit_battle_lose_a4cc2f6c:

    # "The bandit kneels, holding the edge of his axe over your neck."
    ""

translate schinese sharkbandit_battle_lose_9303bf6e:

    # e "...To catch the thief that stole our plums, that's it."
    e ""

translate schinese sharkbandit_battle_lose_fa9da81c:

    # sbd "Nothing else?"
    sbd ""

translate schinese sharkbandit_battle_lose_d3e2cbe3:

    # "You nod. The bandit boss seems rather perplexed, but he just continues with his questioning."
    ""

translate schinese sharkbandit_battle_lose_34b4e2f0:

    # sbd "Where are you from?"
    sbd ""

translate schinese sharkbandit_battle_lose_420a0dab:

    # e "Lusterfield, I f-followed the r-rat thief here."
    e ""

translate schinese sharkbandit_battle_lose_361186de:

    # sbd "The one where the hyena lives, huh? how's he?"
    sbd ""

translate schinese sharkbandit_battle_lose_cd474b97:

    # e "Uh... doing well."
    e ""

translate schinese sharkbandit_battle_lose_127c8ba3:

    # "He chuckles, slowly pulling his axe away."
    ""

translate schinese sharkbandit_battle_lose_207cdaec:

    # sbd "Alright, you came over dangerous place here just for some plums."
    sbd ""

translate schinese sharkbandit_battle_lose_92178d26:

    # sbd "Tell me, what's the end goal here."
    sbd ""

translate schinese sharkbandit_battle_lose_d3c0018b:

    # e "I-I... I just wanted to catch the thief. I didn't know about you people."
    e ""

translate schinese sharkbandit_battle_lose_4678cfa9:

    # sbd "Fair."
    sbd ""

translate schinese sharkbandit_battle_lose_dde5ba0b:

    # sbd "Then, well."
    sbd ""

translate schinese sharkbandit_battle_lose_c3c82f40:

    # sbd "Let's get to the fun part, shall we?"
    sbd ""

translate schinese sharkbandit_battle_lose_75ab91e4:

    # e "W-wait..."
    e ""

translate schinese sharkbandit_battle_lose_7a2f1390:
...
translate schinese sharkbandit_battle_lose_4c677d37:

    # sbd "You can keep your plums, but don't ever come back, I'd hate to break a good toy so soon."
    sbd ""

translate schinese sharkbandit_battle_lose_4b2d5523:

    # "Soon, you black out as the boss approaches you with full clothes, dragging you along the road."
    ""

translate schinese sharkbandit_battle_lose_02774032:

    # "A few hours passed."
    ""

translate schinese sharkbandit_battle_lose_a39fa1b0:
...
translate schinese sharkbandit_battle_lose_34cf9c4c:

    # "Your muscles are sore, ass still gaping from the cocks you've had."
    ""

translate schinese sharkbandit_battle_lose_0cc06f31:

    # "It seems your belly is getting smaller and smaller, but you're still leaking some leftover cum as you stand up."
    ""

translate schinese sharkbandit_battle_lose_8489be74:

    # "But, it was so good... feeling his cocks inside of you, being violently thrusted and-"
    ""

translate schinese sharkbandit_battle_lose_b0653e75:

    # "Shaking off the thoughts, you pick up your belongings and quickly carry onto your journey."
    ""

translate schinese sharkbandit_battle_lose_c8742c33:

    # "You lost [lost_gold] gold."
    ""

translate schinese sharkbandit_battle_win_ac0cf0cc:

    # sbd "F-fuck."
    sbd ""

translate schinese sharkbandit_battle_win_b6efe7ca:

    # "He lies on the ground, panting heavily. And his belly doesn't help but rolls him further down."
    ""

translate schinese sharkbandit_battle_win_9a5935ee:

    # msg "Bandit Boss Winning Scene WIP!"
    msg ""

translate schinese sharkbandit_battle_win_bc46e54b:

    # sbd "What do you want?"
    sbd ""

translate schinese sharkbandit_battle_win_1536264c:

    # e "Where's the thief that stole my plums?"
    e ""

translate schinese sharkbandit_battle_win_94a954d3:

    # sbd "Plums? They're over there, just take it."
    sbd ""

translate schinese sharkbandit_battle_win_9bc890e9:

    # sbd "Look, if you kill me right here, my people will make sure to destroy where you live, and you'll suffer for eternity."
    sbd ""

translate schinese sharkbandit_battle_win_53a12269:

    # sbd "Think you can handle all of them?"
    sbd ""

translate schinese sharkbandit_battle_win_f02f8a02:

    # e "Just tell me where the thief is."
    e ""

translate schinese sharkbandit_battle_win_e967f615:

    # sbd "..."
    sbd ""

translate schinese sharkbandit_battle_win_bd09c823:

    # sbd "He's out there, but I'm not giving him up."
    sbd ""

translate schinese sharkbandit_battle_win_addd4870:

    # e "Not at the risk of your life?"
    e ""

translate schinese sharkbandit_battle_win_5b95c291:

    # sbd "No. Take your plums and gold, but not my men."
    sbd ""

translate schinese sharkbandit_battle_win_dfa3ef8b:

    # e "A-alright, I don't want to kill anyone here."
    e ""

translate schinese sharkbandit_battle_win_c849fd86:

    # e "But if you and your thieves ever come back to our farm, I can't promise anything."
    e ""

translate schinese sharkbandit_battle_win_0079b4a8:

    # sbd "Whatever you say, adventurer."
    sbd ""

translate schinese sharkbandit_battle_win_2dffc7ee:

    # e "Can I trust your words?"
    e ""

translate schinese sharkbandit_battle_win_d6fbb0fc:

    # sbd "People often say you shouldn't trust a bandi-"
    sbd ""

translate schinese sharkbandit_battle_win_888bc334:

    # "You blankly stare at him, with your weapon still on your hand."
    ""

translate schinese sharkbandit_battle_win_9438339a:

    # sbd "But y-yes."
    sbd ""

translate schinese sharkbandit_battle_win_d5298768:

    # "You leave the bandit boss behind and take the plum inside the hideout before you pick up your stuff, and move on."
    ""

translate schinese sharkbandit_battle_win_01346965:

    # "The shark gives you a few glances before getting up, going back to his shelter pretending like nothing happened."
    ""

translate schinese sharkbandit_battle_win_0efb5857:

    # "With the boss' promise. At least you can now go back with the plums and not having to worry about the thief."
    ""

translate schinese sharkbandit_battle_win_a20cefa7:

    # "..."
    ""

translate schinese sharkbandit_battle_win_4606f40b:

    # "You received 300 exp and 150 gold."
    ""

translate schinese sharkbandit_battle_win_91f1d522:
