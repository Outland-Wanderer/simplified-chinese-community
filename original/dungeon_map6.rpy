...
translate schinese Whispering_Hollow_Loop_16c08970:

    # "You hear a wooden clank sound from afar, it seems something has opened."
    ""

translate schinese Whispering_Hollow_Loop_1c02c8e5:

    # "You run into a chest in the forest, you walk towards it, trying to open the chest."
    ""

translate schinese Whispering_Hollow_Loop_e4a118d9:

    # "Suddenly the chest jumps right into your face, it's not a chest, it is a mimic."
    ""

translate schinese Whispering_Hollow_Loop_384c5823:

    # "Mimic" "RAWAWWWR-"
    "Mimic" ""

translate schinese Whispering_Hollow_Loop_68fd897f:

    # "You scream, its tongue is slithering out, trying to latch on you..."
    ""

translate schinese Whispering_Hollow_Loop_8f4b5a9c:

    # ww "Hey, dude. Guess what, Uffe doesn't let me return to our den."
    ww ""

translate schinese Whispering_Hollow_Loop_4e7ff085:

    # e "That's a bummer."
    e ""

translate schinese Whispering_Hollow_Loop_3cbaec72:

    # ww "Yeah, yeah."
    ww ""

translate schinese Whispering_Hollow_Loop_8fda86e4:

    # "The werewolf continues watching over the empty hollow."
    ""

translate schinese Whispering_Hollow_Loop_1b037ac5:

    # ww "Oh... damn. You've done it."
    ww ""

translate schinese Whispering_Hollow_Loop_69b862df:

    # ww "Turns out, what I need to put there is in my pocket all along!"
    ww ""

translate schinese Whispering_Hollow_Loop_0029ca51:

    # "The werewolf reveals a piece of iron from his loincloth."
    ""

translate schinese Whispering_Hollow_Loop_1b78a4f9:

    # ww "I was going to solve it so easily, if only all of the answers were meat, hmmm..."
    ww ""

translate schinese Whispering_Hollow_Loop_43ca3024:

    # e "Yeah, guess I'm going back to Uffe with the amulet."
    e ""

translate schinese Whispering_Hollow_Loop_0c6e7e10:

    # ww "Good luck, dude."
    ww ""

translate schinese Whispering_Hollow_Loop_ca52a0cf:

    # ww "Oh, and remember to clear the shrubs. We're going to hunt down much more preys here."
    ww ""

translate schinese Whispering_Hollow_Loop_2255f5d6:

    # "He waves you a farewell, before sitting lazily."
    ""

translate schinese Whispering_Hollow_Loop_5f7b93b1:

    # "You notice a huge werewolf peeking by the side of the hollow."
    ""

translate schinese Whispering_Hollow_Loop_ba53a226:

    # "He looks worried, to say the least. Not overly aggressive like the others."
    ""

translate schinese Whispering_Hollow_Loop_581629cf:

    # ww "Oh?"
    ww ""

translate schinese Whispering_Hollow_Loop_dde308d5:

    # "The werewolf notices you."
    ""

translate schinese Whispering_Hollow_Loop_01491e7b:

    # ww "Uffe sent you?"
    ww ""

translate schinese Whispering_Hollow_Loop_18967a55:

    # e "Uhm... yes. I was worried you're going to attack me."
    e ""

translate schinese Whispering_Hollow_Loop_eaf21e66:

    # ww "N-no. We don't have time for that."
    ww ""

translate schinese Whispering_Hollow_Loop_92db29ba:

    # "Both of you remain silent for a minute, as the werewolf removes his gaze on you."
    ""

translate schinese Whispering_Hollow_Loop_fdcb1662:

    # "He takes another glance at the paper, and looks over the hollow."
    ""

translate schinese Whispering_Hollow_Loop_10fe600a:

    # ww "Fuck, man. Why do we even bother with this thing."
    ww ""

translate schinese Whispering_Hollow_Loop_74cdafb0:
...
translate schinese Whispering_Hollow_Loop_7429056a:

    # "He finishes the riddle with a loud sigh."
    ""

translate schinese Whispering_Hollow_Loop_e9bd0086:

    # ww "W-what can it be? We've spent a whole week over this, maybe it's food, or... meat? That's not right."
    ww ""

translate schinese Whispering_Hollow_Loop_c4089a3e:

    # ww "Or..."
    ww ""

translate schinese Whispering_Hollow_Loop_d3066dc2:

    # ww "Maybe it's food! Y-yes. Food. W-wait a minute..."
    ww ""

translate schinese Whispering_Hollow_Loop_c0becb45:

    # "The werewolf falls into another period of pondering, you decide to leave him alone, and inspect the pillars."
    ""

translate schinese Whispering_Hollow_Loop_5f7b93b1_1:

    # "You notice a huge werewolf peeking by the side of the hollow."
    ""

translate schinese Whispering_Hollow_Loop_d2edc994:

    # ww "W-what can that mean? Hard and Unyielding... My cock can be like that, maybe not {i}honed to a deadly point.{/i}"
    ww ""

translate schinese Whispering_Hollow_Loop_ade48d60:

    # ww "Wouldn't make sense to {i}till the land{/i} also."
    ww ""

translate schinese Whispering_Hollow_Loop_85d2bd74:

    # ww "But I can put my cock on the pillar, it'll probably fit."
    ww ""

translate schinese Whispering_Hollow_Loop_06eefad7:
...
translate schinese Whispering_Hollow_Loop_63639cea:

    # "After cutting through the last shrub, it seems you've cleared the area."
    ""

translate schinese Whispering_Hollow_Loop_73cc25dc:

    # "The Pillar says..."
    ""

translate schinese Whispering_Hollow_Loop_a5a943bb:
...
translate schinese Whispering_Hollow_Loop_73cc25dc_1:

    # "The Pillar says..."
    ""

translate schinese Whispering_Hollow_Loop_ebf519a8:
...
translate schinese Whispering_Hollow_Loop_73cc25dc_2:

    # "The Pillar says..."
    ""

translate schinese Whispering_Hollow_Loop_8866c5d2:
...
translate schinese Whispering_Hollow_Loop_73cc25dc_3:

    # "The Pillar says..."
    ""

translate schinese Whispering_Hollow_Loop_bbe8d806:
...
translate schinese Whispering_Hollow_Loop_73cc25dc_4:

    # "The Pillar says..."
    ""

translate schinese Whispering_Hollow_Loop_ae841a1c:
...
translate schinese Whispering_Hollow_Loop_6466610a:

    # "Without the amulet, all that's left in the pillar is its own self..."
    ""

translate schinese Whispering_Hollow_Loop_c2564626:

    # "You read the shining paragraph on the pillar."
    ""

translate schinese Whispering_Hollow_Loop_03a96509_1:

    # "{i}I am a moonstone of werewolf might, a symbol of strength in the fight.{w}{p}But to harness my true power and glory, the price of sacrifice must be your story.{/i}"
    ""

translate schinese Whispering_Hollow_Loop_274aba80:

    # "It fades soon after, leaving only the amulet on top of the pillar."
    ""

translate schinese Whispering_Hollow_Loop_884f0b56:

    # "You snatch the moonstone amulet from its light, and put it in your bag."
    ""

translate schinese Whispering_Hollow_Loop_0966c114:
